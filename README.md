...
Проект создан для того, чтобы упростить доступ пользователей к информации. Вместо ручной отправки материалов бот помогает разложить данные по разделам, показывает нужную информацию через меню и делает взаимодействие с проектом более удобным.
...
Пользователь запускает бот, выбирает нужный раздел в меню и получает информацию в понятном формате.
